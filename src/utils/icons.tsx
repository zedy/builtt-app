...
export function Cross({ w, h, c }: Props) {
  return (
    <svg
      width={w}
      height={h}
...
export function Google({ w, h }: Props) {
  return (
    <svg
      width={w}
      height={h}
...
export function Cart({ w, h, c }: Props) {
  return (
    <svg
      width={w}
      height={h}
...
export function Profile({ w, h, c }: Props) {
  return (
    <svg
      width={w}
      height={h}
...
export function Login({ w, h, c }: Props) {
  return (
    <svg
      width={w}
      height={h}
